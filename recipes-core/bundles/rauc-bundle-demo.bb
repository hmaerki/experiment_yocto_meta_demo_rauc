...
RAUC_SLOT_rootfs ?= "core-image-minimal-demo"

RAUC_KEY_FILE = "/workdir/meta-demorauc/conf/keys/demorauc.key.pem"
RAUC_CERT_FILE = "/workdir/meta-demorauc/conf/keys/demorauc.cert.pem"
